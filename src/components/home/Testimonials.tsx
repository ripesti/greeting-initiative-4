...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      name: 'Сергей',
      service: 'Подбор и юридическое сопровождение',
      rating: 5,
      text: 'Очень грамотный специалист в своей сфере. Обратились за помощью в подборе и юридическом сопровождении сделки на вторичную недвижимость. С самого начала всё было так как и должно, когда работаешь с профессионалом. Грамотная консультация, обратная связь (почти в любое время), никаких навязанных дополнительных услуг, все четко и по делу. Было видно, что человек получает удовольствие от своей работы, отсюда и результат. Весь процесс проходил в дружеской и доброжелательной атмосфере. Спасибо, будем обращаться ещё.',
      date: '10.12.2025'
    },
    {
      name: 'Александр',
      ...
      rating: 5,
      text: 'Очень грамотный специалист, помогла с делом за которое многие адвокаты не брались, в силу того что небыло должного опыта, либо говорили что ничего не получится. Ольга Коваленко занялась и все получилось, дело правда длилось очень долго, не темнеменне успешно, больше спасибо!',
      date: '27.11.2025'
    },
    {
    ...
    {
      name: 'Анастасия',
      service: 'Продажа квартиры и оформление ипотеки',
      rating: 5,
      text: 'Ольга Коваленко - профессионал своего дела. Обратилась к ней с целью продажи квартиры. Всегда была на связи и отвечала на все интересующие меня вопросы. Сделку провели быстро и качественно, после чего буквально за три дня помогла нам оформить ипотеку на новостройку в другом регионе по самой выгодной процентной ставке. За что ей огромное спасибо! Успели запрыгнуть в последний вагон перед Новым годом! Если вам нужно купить или продать квартиру, смело обращайтесь к Ольге! Буду рекомендовать её друзьям и знакомым.',
      date: '14.10.2024'
    },
    {
      name: 'Анвар',
